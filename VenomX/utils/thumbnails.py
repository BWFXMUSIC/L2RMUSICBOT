...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("PROFESSOR-SOURABH/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('PROFESSOR-SOURABH/assets/font.ttf', 30)
            font2 = ImageFont.truetype('PROFESSOR-SOURABH/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('PROFESSOR-SOURABH/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('PROFESSOR-SOURABH/assets/font2.ttf', 35)
